...
namespace FavoDeMel.Api.Controllers
{
    ...
    public class ValuesController : BaseController
    {
        ...
        private readonly IComandaRepository _testeRepository;

        public ValuesController(IUnitOfWork unitOfWork,
            ICommandDispatcher commandDispatcher,
            IHubContext<FavoDeMelHub> hub,
            IComandaRepository testeRepository) : base(commandDispatcher,unitOfWork)
        {
            _hub = hub;
        ...
        public async Task<IEnumerable<string>> Get()
        {
           ...
           // await _commandDispatcher.HandleAsync(new AbrirComandaCommand(0));
